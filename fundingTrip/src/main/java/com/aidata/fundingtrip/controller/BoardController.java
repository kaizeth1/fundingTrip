...
public class BoardController {
	...
	public String hisWriteProc(@RequestPart List<MultipartFile> files, HistoryBoardDto hbDto, HttpSession session, RedirectAttributes rttr) {
		log.info("hisWriteProc()");
		String view = bServ.hisWrite(hbDto, session, rttr);
		return view;
	}
	...
	public String hisUpdateProc(List<MultipartFile> files, HistoryBoardDto hbDto, HttpSession session, RedirectAttributes rttr) {
		log.info("hisUpdateProc()");
		String view = bServ.hisUpdate(hbDto, session, rttr);
		return view;
	}
	...
	public String qnaWriteProc(QnABoardDto qDto, HttpSession session, RedirectAttributes rttr) {
		...
		String view = bServ.qnaWrite(qDto, session, rttr);
		return view;
	}
	...
	public String qnaUpdateProc(QnABoardDto qDto, HttpSession session, RedirectAttributes rttr) {
		...
		String view = bServ.qnaUpdate(qDto, session, rttr);
		return view;
	}
}